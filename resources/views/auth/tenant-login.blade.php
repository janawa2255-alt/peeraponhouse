...
<div class="min-h-screen flex items-center justify-center bg-neutral-950 px-4">
    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-600 to-orange-500 text-white font-bold text-2xl shadow-lg shadow-orange-900/40 mb-4">
                PH
            </div>
        ...
        {{-- Login Card --}}
        <div class="bg-neutral-900/80 border border-orange-500/20 rounded-2xl shadow-2xl shadow-black/40 overflow-hidden backdrop-blur-xl">
            <div class="px-8 py-6">
                <form method="POST" action="{{ route('login.tenant') }}" class="space-y-5">
                    ...
                    <p class="text-xs text-gray-400 bg-neutral-800/40 rounded-lg px-3 py-2 border border-neutral-700/50">
                        ...
                        หากลืมรหัสผ่าน กรุณาติดต่อเจ้าของหอหรือแอดมิน
                    </p>
